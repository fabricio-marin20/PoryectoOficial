...
if (filter_input(INPUT_POST, 'action') != null) {
    ...
    try {
        ...
        if ($action === "add_personas" or $action === "update_personas") {
            ...
            if ((filter_input(INPUT_POST, 'PK_cedula') != null) && (filter_input(INPUT_POST, 'nombre') != null) && (filter_input(INPUT_POST, 'apellido1') != null) && (filter_input(INPUT_POST, 'apellido2') != null) && (filter_input(INPUT_POST, 'Correo') != null) && (filter_input(INPUT_POST, 'Usu') != null) && (filter_input(INPUT_POST, 'Contrasena') != null) && (filter_input(INPUT_POST, 'tel') != null)&& (filter_input(INPUT_POST, 'TipoUsuario') != null)) {
                ...
                $myPersonas->setUsu(filter_input(INPUT_POST, 'Usu'));
                $myPersonas->setContrasena(filter_input(INPUT_POST, 'Contrasena'));
                $myPersonas->settel(filter_input(INPUT_POST, 'tel'));
